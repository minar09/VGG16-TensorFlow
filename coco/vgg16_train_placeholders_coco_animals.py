...
if __name__ == '__main__':
    ...
    # validation images
    all_validation_images, all_validation_image_labels = dp._get_images("validation")
        ...
        for epoch in range(1, training_epochs + 1):
            ...
            for m in range(num_steps):            
                try:
                    ...
                    batch_val_images, batch_val_labels = dp.get_next_batch_of_training_images(step_images, step_labels)
                    ...
                    if (m + 1) % display_step == 0 and m > 0:
                        print("Epoch:", epoch, ", step:", m + 1, ", Validation Accuracy:", val_acc)
            ...
            print("Training accuracy: ", training_accuracy * 100, "%, Loss: ", loss_here, ", Validation accuracy: ", validation_accuracy * 100, "%, ", epoch, "th epoch.")
