...
def main():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(training_epochs):
            ...
            for i in range(num_batch):
                ...
                try:
                    if i % display_step == 0:    # accuracy check
                        ...
                        print("epoch:{},batch:{}/{}".format(epoch, i, num_batch), "acc:{0:.4f}".format(
                            test_accuracy), "ex-time: {0:.2f}sec".format(time.time()-start))
                        writer_test.add_summary(sess.run(merged_history, feed_dict={
                                                accuracy_history: test_accuracy * 100}), log_writer_step)
            ...
            print("Epoch:", epoch, ", Average validation accuracy:",
