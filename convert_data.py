...
def main():
    ...
    try:
        ...
        convert_to_tfrecord(test_image_names, testing_GT,
                            converted_test_data_filepath, "testing")
    except Exception as err:
        print("Exception: ", err)
    ...
    try:
        ...
        convert_to_tfrecord(val_image_names, validation_GT,
                            converted_val_data_filepath, "validation")
    except Exception as err:
        print("Exception: ", err)
    ...
    try:
        ...
        convert_to_tfrecord(all_training_images, all_training_image_labels,
                            converted_train_data_filepath, "training")
    except Exception as err:
        print("Exception: ", err)
